...
import javax.swing.*;
public class test {
// test owns the MODEL -- state of the balls
Ball[] balls;
int ballCount;
// test also owns the VIEW objects -- displaying the balls
JFrame f;
Game gamePanel;
...
double oldx, oldy;
public Ball() {
x = (int) (Math.random() * 500 + 100); // [100, 500)
y = (int) (Math.random() * 500 + 100);
vx = (int) (Math.random() * 400 - 50); // [-50, 50)
vy = (int) (Math.random() * 400 - 50);
}
