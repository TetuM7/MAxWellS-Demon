...
public class MaxwellsDemon {

	String tempp1;
	String tempp2;
			
	// MaxwellsDemon owns the MODEL -- state of the balls
	Ball[] balls;
	int ballCount;
	double coldloc;
	double hotloc;
	...
	JButton resetgame;
	JLabel temp2;
	// MaxwellsDemon also owns the VIEW objects -- displaying the balls
	JFrame f;
	Game gamePanel;
	boolean isblue;
	boolean isgate;
	...
	public MaxwellsDemon() {
		...
		holdthese.setLayout(new GridLayout(1,2));
